...
import { Mail, MapPin, Facebook, ExternalLink, Heart } from "lucide-react";
...
const Contact = () => {
  ...
  const supportLinks = [
    {
      name: "Venmo",
      url: "https://venmo.com/u/SilverCircuits16158",
      description: "Support us via Venmo",
      color: "text-blue-400"
    },
    {
      name: "GoFundMe",
      url: "https://gofund.me/cb49a9f8",
      description: "Contribute to our team goals",
      color: "text-green-400"
    },
    {
      name: "PayPal",
      url: "https://www.paypal.com/US/fundraiser/charity/4735879",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 circuit-bg p-12 rounded-2xl">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Have questions about our team? Want to support our robotics journey? We'd love to hear from you!
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a 
                      href="mailto:vcscrobotics@gmail.com"
            ...
            <Card className="bg-gradient-tech border-border">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  FIRST Tech Challenge is an extracurricular program for students in grades 7–12 to learn about the fields of science, technology, engineering, and math (STEM) through hands-on learning in the field of robotics.
                </p>
